...
/**
  ...
  */
case class JdbcInsertTableAction(requestName: Expression[String], tableName: Expression[String], values: Expression[String], statsEngine: StatsEngine, next: Action) extends ChainableAction with NameGen {
